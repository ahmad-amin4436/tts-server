// ui/script.js
// Client-side JavaScript for the DEVNET TTS Server web interface.
...
document.addEventListener('DOMContentLoaded', async function () {
    ...
    function initializeApplication() {
        ...
        const pageTitle = currentConfig?.ui?.title || "DEVNET TTS Server";
    ...
    async function fetchInitialData() {
        try {
            ...
            if (Object.keys(currentConfig).length === 0) {
                currentConfig = { ui: { title: "DEVNET TTS Server (Error Mode)" }, generation_defaults: {}, ui_state: {} };
                currentUiState = currentConfig.ui_state;
            }
